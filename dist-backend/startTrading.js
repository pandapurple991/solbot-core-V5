    ...
    try {
        ...
        while (globalTradingFlag.value) {
            ...
            while (globalTradingFlag.value && Date.now() - startTime < swapConfig_1.swapConfig.buyDuration) {
                ...
                const buyAmount = getRandomAmount(swapConfig_1.swapConfig.minPercentage, swapConfig_1.swapConfig.maxPercentage, solBalance - swapConfig_1.swapConfig.RENT_EXEMPT_SWAP_FEE);
                ...
                const buyAmountSecond = getRandomAmount(swapConfig_1.swapConfig.minPercentage, swapConfig_1.swapConfig.maxPercentage, solBalanceSecond - swapConfig_1.swapConfig.RENT_EXEMPT_SWAP_FEE);
                const buyTxHashSecond = await performSwap(raydiumSwap, 'buy', buyAmountSecond, walletNumber);
                if (buyTxHashSecond) {
                    const tokenBalanceSecond = await (0, exports.getTokenBalance)(raydiumSwap, tokenAddress);
